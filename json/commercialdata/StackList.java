package com.bridgelabz.json.commercialdata;
...
//		}
		...
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("/home/admin1/eclipse-workspace/doc2")))
		{
	...
	public void write1()
	{
		...
		try (BufferedWriter bw = new BufferedWriter(new FileWriter("/home/admin1/eclipse-workspace/doc1")))
		{
			bw.write(str);
			System.out.println("Done");
			bw.close();
